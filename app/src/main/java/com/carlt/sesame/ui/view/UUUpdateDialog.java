...
public class UUUpdateDialog extends Dialog {
	...
	public UUUpdateDialog(Context context, DialogUpdateListener dialogUpdateListener) {
		...
		txtProgress = (TextView) view.findViewById(R.id.update_loading_txt_progress);
	...
	protected GetResultListCallback listener_polling = new GetResultListCallback() {
...
//						LoginInfo.setUpgradeing(true);
						...
						if (progressValue > -1 && progressValue < 121) {
							...
							destoryTimer();
							UUToast.showUUToast(mContext, "芝麻盒子升级失败...");
							dismiss();
