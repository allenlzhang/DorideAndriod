...
public class MainActivity extends BaseActivityGroup implements OnCheckedChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        isTransferDialog = getIntent().getBooleanExtra("showTransferDialog", false);
            ...
            if (LoginInfo.isMain()) {
                ...
                if (isTransferDialog) {
                    PopBoxCreat.createDialogNotitleOneBtn(MainActivity.this, "过户成功", "可以正常登陆芝麻乐园", "确定", new DialogWithTitleClick() {
    ...
    public void setCurrentView(int index) {
        ...
        switch (index) {
            ...
            case 0:
                intent = new Intent(MainActivity.this, CareerMainActivity.class);
                break;
            ...
            case 2:
                intent = new Intent(MainActivity.this, RemoteMainNewActivity.class);
                break;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            UUFeetipDialog mUuFeetipDialog = new UUFeetipDialog(MainActivity.this);
            switch (msg.what) {
                case 0:
                    // if (LoginInfo.isMain()) {
                ...
                case 1:
                    ...
                    if (mInfo != null) {
                        ...
                        if (message != null && !message.equals("")) {
                            UUToast.showUUToast(MainActivity.this, message);
                        }
                    }
                    break;
                case 2:
                ...
                case 4:
                    ...
                    PopBoxCreat.createDialogNotitleOneBtn(MainActivity.this, "版本更新" + mCurVersionInfo.getVersion(), mCurVersionInfo.info, "确定", new DialogWithTitleClick() {
                        @Override
                        public void onLeftClick() {
                        }
