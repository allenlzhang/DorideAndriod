...
public class FolderImgListAdapter extends BaseAdapter {
	...
	public FolderImgListAdapter(Context context,
			List<HashMap<String, String>> listdata) {
	...
	public View getView(final int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg0 != index && arg0 > index) {
			...
			arg1 = LayoutInflater.from(context).inflate(
					R.layout.folder_img_dapter, null);
			holder.photo_imgview = (ImageView) arg1
					.findViewById(R.id.folder_img_dapter_img);
			holder.filecount_textview = (TextView) arg1
					.findViewById(R.id.folder_img_dapter_num);
			holder.filename_textView = (TextView) arg1
					.findViewById(R.id.folder_img_dapter_text);
			arg1.setTag(holder);
			holderlist.add(arg1);
		} else {
