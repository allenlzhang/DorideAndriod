...
public class ReportMonthFragment6 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View convertView = inflater.inflate(R.layout.layout_report_month6, null);

        mTextLable1 = (TextView)convertView.findViewById(R.id.layout_report_month6_lable1);
        mTextLable2 = (TextView)convertView.findViewById(R.id.layout_report_month6_lable2);
        mTextLable3 = (TextView)convertView.findViewById(R.id.layout_report_month6_lable3);

        mTextMy1 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative1_txt2);
        mTextType1 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative1_txt3);
        mTextDesc1 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative1_txt4);

        mTextMy2 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative2_txt2);
        mTextType2 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative2_txt3);
        mTextDesc2 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative2_txt4);

        mTextMy3 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative3_txt2);
        mTextType3 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative3_txt3);
        mTextDesc3 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative3_txt4);

        mTextMy4 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative4_txt2);
        mTextType4 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative4_txt3);
        mTextDesc4 = (TextView)convertView.findViewById(R.id.layout_report_month6_relative4_txt4);

        mImageView1 = (ImageView)convertView.findViewById(R.id.layout_report_month6_relative1_img);
        mImageView2 = (ImageView)convertView.findViewById(R.id.layout_report_month6_relative2_img);
        mImageView3 = (ImageView)convertView.findViewById(R.id.layout_report_month6_relative3_img);
        mImageView4 = (ImageView)convertView.findViewById(R.id.layout_report_month6_relative4_img);

        mSeekBars = new ArrayList<SeekBar>();

        mSeekBars.add((SeekBar)convertView
                .findViewById(R.id.layout_report_month6_relative1_seekbar));
        mSeekBars.add((SeekBar)convertView
                .findViewById(R.id.layout_report_month6_relative2_seekbar));
        mSeekBars.add((SeekBar)convertView
                .findViewById(R.id.layout_report_month6_relative3_seekbar));
        mSeekBars.add((SeekBar)convertView
                .findViewById(R.id.layout_report_month6_relative4_seekbar));
    ...
    public void LoadDate() {
        try {
            String tag = mReportMonthInfo.getTag();
            ...
            mTextDesc1.setText(mReportMonthInfo.getBrakedesc());
            mTextDesc2.setText(mReportMonthInfo.getTurndesc());
            mTextDesc3.setText(mReportMonthInfo.getSpeedupdesc());
            mTextDesc4.setText(mReportMonthInfo.getOverspeeddesc());

            // mTextDesc1.setText(GetTextDescription.getStringReportDrivingTestDetail(
            // mReportMonthInfo.getBrake(), GetTextDescription.TYPE_BRAKE));
            // mTextDesc2.setText(GetTextDescription.getStringReportDrivingTestDetail(
            // mReportMonthInfo.getTurn(), GetTextDescription.TYPE_SWERVE));
            // mTextDesc3.setText(GetTextDescription.getStringReportDrivingTestDetail(
            // mReportMonthInfo.getSpeedup(),
            // GetTextDescription.TYPE_ACCELERATE));
            // mTextDesc4.setText(GetTextDescription.getStringReportDrivingTestDetail(
            // mReportMonthInfo.getOverSpeed(),
