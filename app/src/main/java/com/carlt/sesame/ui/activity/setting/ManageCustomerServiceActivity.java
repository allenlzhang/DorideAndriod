...
public class ManageCustomerServiceActivity extends BaseActivity {
    ...
    protected void onResume() {
        super.onResume();
        showFlag = dragViewCtr.isShowFlag();
        isshowDragCB.setChecked(showFlag);
    }
    ...
    private void setListener() {
        ...
        isshowDragCB.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                dragViewCtr.setShow(isChecked);
                if (!isChecked) {
                    dragViewCtr.justhideDragCallView();
                } else {
                    if (showFlag) {
                        dragViewCtr.showDragView();
                    }  else {
