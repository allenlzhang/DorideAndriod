...
public class ReportMonthActivity extends BaseFragmentActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FragmentMonthAdapter(getSupportFragmentManager());
        ...
        if (monthInitialValue == null || monthInitialValue.equals("")) {
            ...
            monthInitialValue = format.format(today.getTime());
        }
        loadData(monthInitialValue);
    }
    ...
    private void loadData(String date) {
        ...
        CPControl.GetMonthReportResult(date, listener);
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    final ReportMonthInfo mReportMonthInfo = (ReportMonthInfo)msg.obj;
                    ...
                    txtRight.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View arg0) {
                            // 晒一晒
//                            ShareControl.share(ReportMonthActivity.class, ReportMonthActivity.this,
...
//                                    mReportMonthInfo.getShareLink(), R.drawable.friends_share_img);
    ...
    private void selectDate() {
        CalendarMonth mCalendarMonth = new CalendarMonth(ReportMonthActivity.this,
                mCalendarMonthClick);
