...
public class RemoteFunInfo extends BaseResponseInfo {
	...
	public final static String FUNC_UNLOCK="11";//解锁
	public final static String FUNC_LOCK="12";//落锁
	public final static String FUNC_FIND="13";//声光寻车
	public final static String FUNC_AIR="14";//空调
	public final static String FUNC_CHARGE="15";//充电
	...
	public final static String MODE_VISIBLITY = "9";//温度显示
