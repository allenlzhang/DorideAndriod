...
package com.carlt.doride.dao.db.table;

import android.database.Cursor;

import com.carlt.doride.dao.db.IDbManager;
import com.carlt.doride.dao.db.annotation.Table;
...
public final class TableEntity<T> {
    ...
    /*package*/ TableEntity(IDbManager db, Class<T> entityType) throws Throwable {
        this.db = db;
