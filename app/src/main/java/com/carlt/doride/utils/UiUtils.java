...
public class UiUtils {
    ...
    public static Context getContext() {
        return DorideApplication.instance.context;
    }

//    //	获取主线程的Handler对象
//    public static Handler getMainThreadHandler() {
//        return DorideApplication.instance.handler;
//    }
//
//    //	获取主线程的线程id
//    public static int getMainThreadId() {
//        return DorideApplication.instance.mainThreadId;
//    }
...
//    }
     ...
     * @param bitmap
     */
    public static ImageView createCopyView(int x, int y, Bitmap bitmap, Activity activity, WindowManager mWindowManager) {
        WindowManager.LayoutParams mLayoutParams = new WindowManager.LayoutParams();
        mLayoutParams.format = PixelFormat.TRANSLUCENT;            //图片之外其他地方透明
        mLayoutParams.gravity = Gravity.TOP | Gravity.LEFT;
        mLayoutParams.x = x;   //设置imageView的原点
        mLayoutParams.y = y - getStatusHeight(activity);
        mLayoutParams.alpha = 1f;                                //设置透明度
        mLayoutParams.width = WindowManager.LayoutParams.WRAP_CONTENT;
        mLayoutParams.height = WindowManager.LayoutParams.WRAP_CONTENT;
        mLayoutParams.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE
                | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE;
        ImageView copyView = new ImageView(activity);
        copyView = new ImageView(activity);
