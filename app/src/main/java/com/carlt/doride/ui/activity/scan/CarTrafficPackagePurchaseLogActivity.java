...
/**
 * Created by Marlon on 2018/12/20.
 */
...
//					CPControl.GetTrafficPackageLogResult(LIMIT, 0,package_type, listener);
    ...
    private void PullDown() {
        // 调用接口
        CPControl.GetTrafficPackageLogResult(URLConfig.getCAR_FLOW_PAY_LOG_URL(), LIMIT, 0, package_type, listener);
    }
    ...
    private void PullUp() {
        ...
        CPControl.GetTrafficPackageLogResult(URLConfig.getCAR_FLOW_PAY_LOG_URL(), LIMIT, ratio * 20, package_type,
                listener_loadmore);
    }
        ...
        if (mInfoLists != null) {
            ...
            if (mAdapter == null) {
                mAdapter = new TrafficPurchaseLogAdapter(
                        CarTrafficPackagePurchaseLogActivity.this,
                        mPurchaseLogList);
