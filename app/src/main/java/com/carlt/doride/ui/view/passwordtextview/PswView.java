...
public class PswView extends View {
    ...
    public PswView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPsw_size = tArray.getDimensionPixelSize(R.styleable.PwdTextView_psw_size, 15);
        ...
        mBorder_color = tArray.getColor(R.styleable.PwdTextView_border_color, Color.parseColor("#cccccc"));
        init(context);
    }
