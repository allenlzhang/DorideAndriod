 ...
 * @author @Y.yun 暂停回放
 */
public class PausePlayBackParser extends RecorderBaseParserNew<BaseResponseInfo> {

	public PausePlayBackParser(CPControl.GetResultListCallback listener) {
	...
	protected long sendMsg() {
		long result = AppsdkUtils.CPPause(mSqnum);
		return result;
	}
