...
public class AACDecoder {
    ...
    //声道数
    private static final int KEY_CHANNEL_COUNT = 1;//1?
    //采样率
    private static final int KEY_SAMPLE_RATE = 4096;//8000
    //用于播放解码后的pcm
	...
	public boolean prepare() {
        ...
        try {
            ...
            //比特率
            mediaFormat.setInteger(MediaFormat.KEY_BIT_RATE, 64 * 1024);
            //用来标记AAC是否有adts头，1->有
	...
	public void decode(byte[] buf, int offset, int length) {
    	...
    	byte[] copyOfRange = Arrays.copyOfRange(buf,offset, length);
//    	Log.e("voice:", "正常的解码："+Arrays.toString(copyOfRange));
        //输入ByteBuffer
