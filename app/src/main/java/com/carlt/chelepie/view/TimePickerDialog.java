...
public class TimePickerDialog {
    ...
    private TimePickerDialogInterface dataPickerDialogInterface;
    ...
    public TimePickerDialog(Context context) {
        ...
        dataPickerDialogInterface = new TimePickerDialogInterface() {
    ...
    private View initDateAndTimePicker2() {
    	View inflate = LayoutInflater.from(mContext).inflate(
                R.layout.datepicker_layout, null);
        mDatePicker = (DatePicker) inflate
                .findViewById(R.id.datePicker);
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (mTag == 0) {
                        	...
                        	getDatePickerValue();
                        	dataPickerDialogInterface.positiveListener();
                        	return;
                        }
                        dialog.dismiss();
     ...
     * 显示日期选择器
     */
    public void showDateAndTimePickerDialog2() {
        mTag=3;
        View view = initDatePicker();
        mAlertDialog = new AlertDialog.Builder(mContext);
        mAlertDialog.setTitle("选择时间");
